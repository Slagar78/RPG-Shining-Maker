...
Gem::Specification.new do |s|
  ...
  s.files = [".rdoc_options".freeze, "COPYING".freeze, "LICENSE.txt".freeze, "ext/strscan/extconf.rb".freeze, "ext/strscan/strscan.c".freeze, "lib/ext/strscan/extconf.rb".freeze, "lib/lib/strscan/strscan.rb".freeze]
